...
func cmPlot() {
	...
	for i := 1; i < 100; i++ {
		...
		s = newSphere(1, 0, Vector{0, 0, 0}, u235Percentage, u238Percentage)
...
func openFile() *os.File {
	filepath := "data/sphere-critical-mass-plot-fast-u235-238-compound.txt"
...
func run() {
	...
	s := newSphere(radius, shieldingThickness, Vector{0, 0, 0}, u235Percentage, u238Percentage)

...
func openFile() *os.File {
	filepath := "data/infinite-u235-fast-depends-on-previous.txt"
...
func run() {
	...
	var numberNeutronsStart = 40000     // Number of neutrons starting
...
func averageNeutronsProduced(s sphere, nStartNeutrons int) (float64, float64) {
	...
	for i := 0; i < n; i++ {
		...
		neutronsProduced[i] = 2.5 * float64(len(previousFissionLocations))

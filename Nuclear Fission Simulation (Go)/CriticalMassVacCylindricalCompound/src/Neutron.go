...
func newNeutron(position Vector, c *cylinder) Neutron {
...
func (n *Neutron) move() {
	...
	u235ThermalFissionLambda := lambda(nU235(n.c.u235Percentage), u235ThermalFissionSigma)
	u235ThermalCaptureLambda := lambda(nU235(n.c.u235Percentage), u235ThermalCaptureSigma)
	u235ThermalScatterLambda := lambda(nU235(n.c.u235Percentage), u235ThermalScatterSigma)

	u238ThermalFissionLambda := lambda(nU238(n.c.u238Percentage), u238ThermalFissionSigma)
	u238ThermalCaptureLambda := lambda(nU238(n.c.u238Percentage), u238ThermalCaptureSigma)
	u238ThermalScatterLambda := lambda(nU238(n.c.u238Percentage), u238ThermalScatterSigma)
	...
	n.medium = n.getCurrentMedium(n.c)
	...
	//fmt.Println(n.c.isNeutronInU235(*n))
...
//	if n.medium == u235 {
//		inverseLambda := (nU235(n.c.u235Percentage) * u235ThermalTotalSigma) + (nU238(n.c.u238Percentage) * u238ThermalTotalSigma)

...
f = open("data/sphere-critical-mass-plot-fast-depends-on-previous-300.txt")
for line in f:
    l = line.split()
...
plt.plot([min(rs), max(rs)], [2.29357625, 2.29357625], color='0.3', label='Asymptote (k$= 2.294 \pm 0.003)$')
plt.xlabel('Sphere radius (cm)')
plt.ylabel('k value')
plt.legend()
plt.savefig("spherical-critical-mass-u235-fast.png")
plt.show()
